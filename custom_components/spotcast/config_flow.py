...
class SpotcastFlowHandler(
    ...
    async def async_oauth_create_entry(self, data: dict[str, Any]) -> FlowResult:
        """Create an entry for Spotcast."""
        self.logger.info("Creating auth entry for Spotcast")
    ...
    async def async_step_reauth(self, entry_data: Mapping[str, Any]) -> FlowResult:
        ...
        self.logger.info("Updating auth config entry")
    ...
    async def async_step_reauth_confirm(
        ...
        self.logger.info("Reauth confirmation dialog should load now")
